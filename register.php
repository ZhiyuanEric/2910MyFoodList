...
<body>
	...
	<div class="container">
        ...
        <h2 style="text-align:center" class = "contentBox">Registration</h2>
        ...
        <!-- buttons desktop -->
			<div class="visible-lg visible-md row">
				<div class="col-md-2 col-md-offset-3" >
					<button id = "1" type="submit" class="btn btn-block" onclick="EntryChecking()" onmouseover="this.style.color='green';" onmouseout="this.style.color='white';">Submit</button>
				</div>
				<div class="col-md-2" >
				...
				<div class="col-md-2" >
					<a href="index.php"><button type="button"  class="btn btn-block" onmouseover="this.style.color='green';" onmouseout="this.style.color='white';">Cancel</button></a>
				</div>
			</div>
			<!-- mobile / tablet -->
			<div class="hidden-lg hidden-md">
				<div style="margin-top:20px" class="col-xs-8 col-xs-offset-2 row">
					<button id="2" type="submit" onclick="EntryChecking()" class="btn btn-block" onmouseover="this.style.color='green';" onmouseout="this.style.color='white';">Submit</button>
				</div>
                <div style="margin-top:20px" class="col-xs-8 col-xs-offset-2 row">
					<button type="reset" value="Reset" class="btn btn-block" onmouseover="this.style.color='green';" onmouseout="this.style.color='white';">Reset</button>
				</div>
